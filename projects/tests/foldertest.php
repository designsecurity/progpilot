...
$framework->add_output("./tests/folders/folder1", array("8"));
$framework->add_output("./tests/folders/folder1", "xss");
$framework->add_output("./tests/folders/folder1", array("\$var2"));
$framework->add_output("./tests/folders/folder1", array("11"));
$framework->add_output("./tests/folders/folder1", "xss");
...
$framework->add_output("./tests/folders/folder2", array("8"));
$framework->add_output("./tests/folders/folder2", "xss");
$framework->add_output("./tests/folders/folder2", array("\$var2"));
$framework->add_output("./tests/folders/folder2", array("11"));
$framework->add_output("./tests/folders/folder2", "xss");
