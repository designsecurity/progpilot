                        ...
                        if($astNode->type !== "exit") {
                            ...
                            switch($astNode->type) {
                                ...
                                case 'AssignmentExpression':
                                    $myExpr = new MyExpr($astNode->right->loc->start->line, $astNode->right->loc->start->column);
                                    
                                    $this->context->getCurrentMycode()->addCode(new MyInstruction(Opcodes::START_ASSIGN));
                                    ...
                                    $this->context->getCurrentMycode()->addCode(new MyInstruction(Opcodes::END_ASSIGN));
                                    
                                    $name = Common::getNameDefinition($astNode->left);
                                    
                                    $myDef = new MyDefinition($astNode->left->loc->start->line, $astNode->left->loc->start->column, $name);
                                ...
                                case 'VariableDeclaration':
                                    foreach($astNode->declarations as $VariableDeclarator) {
                                        ...
                                        if ($myinit != null) {
                                            $myExpr = new MyExpr($VariableDeclarator->id->loc->start->line, $VariableDeclarator->id->loc->start->column);
                                            ...
                                            /* var identifier = */
                                            /* = init */
                                            $mydef = new MyDefinition($VariableDeclarator->id->loc->start->line, $VariableDeclarator->id->loc->start->column, $VariableDeclarator->id->name);
                                            ...
                                            switch ($myinit->type) {
                                                ...
                                                default:
                                                    ...
                                                    $mytemp = new MyDefinition($myinit->loc->start->line, $myinit->loc->start->column, $name);
                                ...
                                case 'CallExpression':
                                    $myExpr = new MyExpr($astNode->loc->start->line, $astNode->loc->start->column);
                                    $this->context->getCurrentMycode()->addCode(new MyInstruction(Opcodes::START_EXPRESSION));
