...
entry: entryNode,
	...
	var start_block_node = context.createNode().appendTo(entryNode, "start_block", data_start);
	...
	var end_block_node = context.createNode().appendTo(completion.normal, "end_block", data_end);
