...
function parseBlockStatement(blockStatement, currentNode, context)
{
    ...
    var start_block_node = context.createNode().appendTo(currentNode, "start_block", data_start);
    ...
    var end_block_node = context.createNode().appendTo(block.normal, "end_block", data_end);
