...
class FuncCall
{
    ...
    public static function instruction($context, $myexpr, $funccall_arr, $is_method = false, $is_static = false)
    {
        ...
        } elseif (isset($context->get_current_op()->nsName->value)) {
            $funccall_name = $context->get_current_op()->nsName->value;
        } elseif (isset($context->get_current_op()->name->value)) {
        ...
        } elseif ($context->get_current_op() instanceof Op\Expr\Print_) {
            $funccall_name = "print";
        } elseif ($context->get_current_op() instanceof Op\Terminal\Echo_) {
            $funccall_name = "echo";
        } elseif ($context->get_current_op() instanceof Op\Expr\Eval_) {
            $funccall_name = "eval";
        }
